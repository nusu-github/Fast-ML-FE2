...
theorem jacobiUpdateAt_counterexample_initial :
  ...
  fin_cases i <;>
    norm_num [blurFusionFixedPointCounterexampleBuilder,
      ...
      FastMLFE2.Core.LocalContext.closedFormDenom,
      FastMLFE2.Core.LocalContext.closedFormForegroundNumerator,
      FastMLFE2.Core.LocalContext.closedFormBackgroundNumerator,
