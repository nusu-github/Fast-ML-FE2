...
private theorem foreground_neighborCost_expand
    ...
    (∑ j, ctx.neighborWeight j *
      ((foreground
          (FastMLFE2.Core.LocalContext.perturbForeground g t) - ctx.fgNeighbor j) ^ 2 +
        (background
          (FastMLFE2.Core.LocalContext.perturbForeground g t) - ctx.bgNeighbor j) ^ 2)) =
      (∑ j, ctx.neighborWeight j *
...
private theorem background_neighborCost_expand
    ...
    (∑ j, ctx.neighborWeight j *
      ((foreground
          (FastMLFE2.Core.LocalContext.perturbBackground g t) - ctx.fgNeighbor j) ^ 2 +
        (background
          (FastMLFE2.Core.LocalContext.perturbBackground g t) - ctx.bgNeighbor j) ^ 2)) =
      (∑ j, ctx.neighborWeight j *
        ((foreground g - ctx.fgNeighbor j) ^ 2 + (background g - ctx.bgNeighbor j) ^ 2)) +
        t ^ 2 * ctx.totalWeight +
